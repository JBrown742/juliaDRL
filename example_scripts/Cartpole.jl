...
# ------------------------------------------------------- #
learn(env, alg; training_iters=100, save_dir=joinpath(@__DIR__, "save_data", "Cartpole"), test_name="PPO_CombinedActorCritic_2", average_window=10)

# ----------------- Visualisation ------------------ # 
# To watch the trained agent, uncomment the line below:


visualise_learning(alg, env, joinpath(@__DIR__, "save_data", "Cartpole", "PPO_CombinedActorCritic_2"); agent_type=CombinedActorCritic)
