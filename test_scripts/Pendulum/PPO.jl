...
combined_network = Chain(
    ...
    Split((Dense(128, 1;init=Flux.glorot_uniform), Dense(128, 1, tanh;init=Flux.glorot_uniform), Chain(Dense(128, 128, leakyrelu;init=Flux.glorot_uniform), Dense(128, 1;init=Flux.glorot_uniform))))
)
...
alg = PPO(ContinuousAct, nworkers(), 512, nworkers(), agent, 256, 0.99, 0.95, 0.2, 1., 0.002, 5)

learn(env, alg; training_iters=1000, save_dir="/home/johnny/Documents/PersonalCode/juliaDRL/test_data/Pendulum", test_name="PPO_CombinedActorCritic_1")
close!(env)
